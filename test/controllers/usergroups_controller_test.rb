...
class UsergroupsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create usergroup" do
    assert_difference('Usergroup.count') do
      post usergroups_url, params: { usergroup: { bespoke: @usergroup.bespoke, draggable: @usergroup.draggable, east: @usergroup.east, name: @usergroup.name, north: @usergroup.north, south: @usergroup.south, west: @usergroup.west } }
    end
  ...
  test "should update usergroup" do
    patch usergroup_url(@usergroup), params: { usergroup: { bespoke: @usergroup.bespoke, draggable: @usergroup.draggable, east: @usergroup.east, name: @usergroup.name, north: @usergroup.north, south: @usergroup.south, west: @usergroup.west } }
